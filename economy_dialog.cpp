...
Economy_Dialog::Economy_Dialog(vector<int> p_i, Civ p) : Themed_Dialog("Finance Ministry"), Player(p), Info_Image(string(assets_directory_path) + "textures/dialogs/economy-dialog-texture.svg", 64, 64)
{
  Player_Income = p_i;
  ...
  Dialog_Root_Frame = Gtk::Frame("Economy of " + string(Player.Get_Name()));
