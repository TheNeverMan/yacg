...
//  Tip_Button = Gtk::Button("Tip");
  ...
  Image_Path End_Turn_Icon_Path(icon_directory + "apply-icon.svg");
  ...
  Manage_Techs_Button.Change_Icon(icon_directory + "science-icon.svg");
  UI_Root_Box.pack_start(Manage_Techs_Button, Gtk::PACK_SHRINK);
  Manage_Economy_Button.Change_Icon(icon_directory + "economy-icon.svg");
  UI_Root_Box.pack_start(Manage_Economy_Button, Gtk::PACK_SHRINK);
  Show_Civs_Button.Change_Icon(icon_directory + "foreign-icon.svg");
  UI_Root_Box.pack_start(Show_Civs_Button, Gtk::PACK_SHRINK);
  Manage_Goverments_Button.Change_Icon(icon_directory + "revolution-icon.svg");
  UI_Root_Box.pack_start(Manage_Goverments_Button, Gtk::PACK_SHRINK);
  Civ_Overview_Button.Change_Icon(icon_directory + "overview-icon.svg");
  UI_Root_Box.pack_start(Civ_Overview_Button, Gtk::PACK_SHRINK);
  Newspaper_Button.Change_Icon(icon_directory + "newspaper-icon.svg");
  ...
  Zoom_In_Button.Change_Icon(icon_directory + "plus-icon.svg");
  Zoom_Out_Button.Change_Icon(icon_directory + "minus-icon.svg");
  ...
  Save_Button.Change_Icon(icon_directory + "load-icon.svg");
  UI_Root_Box.pack_start(Save_Button, Gtk::PACK_SHRINK);
  Load_Button.Change_Icon(icon_directory + "load-icon.svg");
  ...
  Image_Path Tip_Icon_Path(icon_directory + "about-icon.svg");
  ...
  Help_Button.Change_Icon(icon_directory + "about-icon.svg");
